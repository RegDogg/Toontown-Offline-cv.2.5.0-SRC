...
class ToonAvatarPanel(AvatarPanelBase.AvatarPanelBase):
    ...
    def __init__(self, avatar, playerId = None):
        ...
        if not hasattr(avatar, 'style'):
            ...
            self.frame = DirectFrame(image=gui.find('**/avatar_panel'), relief=None, pos=(-0.234, 0, -0.475), parent=base.a2dTopRight)
            ...
            self.nameLabel = DirectLabel(parent=self.frame, pos=(0.0125, 0, 0.4), relief=None, text=self.avName, text_font=ToontownGlobals.getInterfaceFont(), text_fg=Vec4(0, 0, 0, 1), text_pos=(0, 0), text_scale=0.042, text_wordwrap=7.5, text_shadow=(1, 1, 1, 1))
