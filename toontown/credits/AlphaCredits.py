...
class Shockley:
    ...
    def load(self):
        ...
        self.image = OnscreenImage(image='phase_4/maps/news/11-17-13_garden.jpg', pos=(-0.5, 0.0, 0.0), scale=(0.5, 0.3, 0.3))
...
class Credits:
    ...
    def load(self):
        ...
        self.image = OnscreenImage(image='phase_4/maps/news/%s' % self.toonImage, pos=imagePos, scale=(0.5, 0.3, 0.3))
        self.elements = [self.title, self.description, self.image]
        if self.twoSlides:
            ...
            self.image2 = OnscreenImage(image='phase_4/maps/news/%s' % self.toon2Image, pos=image2Pos, scale=(0.5, 0.3, 0.3))
...
CreditsScenes = [Shockley(),
 ...
 Credits('Logano', 'Professional Procrastinator\nTTOff Lead Developer\nProject Manager', 'logano.jpg', 'left'),
 Credits('B.D. Pinkermash', 'Nerd\nSecondary Developer', 'sparky.png', 'left', 2, 'Ned', 'Certified House Sitter\nDeveloper', 'nedpls.png'),
 Credits('Giggletwist', 'Infinite Creativity\nDeveloper', 'giggletwist.png', 'right', 2, 'Super Tricky', 'Fishing Specialist\nDeveloper', 'supertricky.png'),
 Credits('Sparkpin', 'ToonFest Conductor\nNot a Donkey\nAssistant Developer', 'sparkpin.png', 'right', 2, 'QED', 'Contributor of many\nMagic Words!', 'qed.png'),
 Credits('Sweet Ratt', 'Field Office Model Repairman\nVery sweet', 'sweetratt.png', 'right', 2, 'S.P. MacSpeed', 'Field Officer\nTTH Developer', 'sillypeppymacspeed.png'),
 Credits('Loblao', 'Created Five Nights\nat the Factory\nTTH Developer', 'loblao.png', 'left'),
