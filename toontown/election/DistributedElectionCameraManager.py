...
class DistributedElectionCameraManager(DistributedObject):
    ...
    def generate(self):
        ...
        self.tv.hide()
        self.tvIdle = Sequence(self.tv.posInterval(2.5, (87.85, -0.25, 22.0), blendType='easeInOut'), self.tv.posInterval(2.5, (87.85, -0.25, 21.0), blendType='easeInOut'))
        self.tvFlyIn = Sequence(Func(self.tv.show), Func(self.tv.setTransparency, 1), Parallel(self.tv.colorScaleInterval(1, colorScale=VBase4(1, 1, 1, 1), startColorScale=VBase4(1, 1, 1, 0)), self.tv.posInterval(4, (87.85, -0.25, 20.0), blendType='easeInOut')), Func(self.tv.setTransparency, 0), self.tv.posInterval(2, (87.85, -0.25, 21.0)), Func(self.tvIdle.loop))
