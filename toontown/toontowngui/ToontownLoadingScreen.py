...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.toon = DirectLabel(parent=self.gui, relief=None, pos=(0, 0, 0.8), text='', textMayChange=1, text_scale=0.17, text_fg=(0.952, 0.631, 0.007, 1), text_align=TextNode.ACenter, text_font=ToontownGlobals.getSignFont())
        self.starring = DirectLabel(parent=self.gui, relief=None, pos=(0, 0, 0.7), text='', textMayChange=1, text_scale=0.1, text_fg=(0.968, 0.917, 0.131, 1), text_align=TextNode.ACenter, text_font=ToontownGlobals.getSignFont())
