...
CRBootedReasons = {1: 'Yikes - An unexpected problem occured.  Your connection has been lost, but you should be able to connect again and go right back into Toontown.',
 100: 'You have been disconnected because someone else just logged in using your account on another computer. See, this is what happens when you LAN.',
 ...
 124: 'Your installed files are out of date!  Use the official launcher to download the newest version, or contact Toontown Offline Support if the problem persists.',
 125: 'Your installed files appear to be invalid.  Use the official launcher to download the newest version, or contact Toontown Offline Support if the problem persists.',
 ...
 128: "There appears to have been a hiccup in your connection to Toontown. You've been trying to LAN, haven't you? You should be able to connect again and go right back into Toontown.",
 151: "You were kicked out by one of the developers working on the servers. Probably because you LAN'd.",
 ...
 154: 'Toontown Offline is going down for an upda-- hey, wait a minute!',
