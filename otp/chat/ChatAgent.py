...
def chatmode(mode = -1):
    ...
    elif mode == 3 and spellbook.getInvoker().getAdminAccess() < 500:
        return 'Chat mode 3 is reserved for system administrators.'
    elif mode == 2 and spellbook.getInvoker().getAdminAccess() < 400:
        return 'Chat mode 2 is reserved for administrators.'
    elif mode == 1 and spellbook.getInvoker().getAdminAccess() < 200:
